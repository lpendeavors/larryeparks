...
import logoCigna from "@/images/logos/cigna_logo.png";
import logoModelOp from "@/images/logos/modelop_logo.jpeg";
import logoSparkEnergy from "@/images/logos/spark_logo.png";
import logoGexaEnergy from "@/images/logos/gexa_logo.jpg";
...
const projects = [
  {
    ...
    link: { href: "https://syllabusplanner.com", label: "syllabusplanner.com" },
  },
  {
    name: "IceBreak",
    description:
    ...
    link: {
      href: "https://testflight.apple.com/join/7nY71z5J",
      label: "IceBreak iOS",
    },
  },
];
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="https://firebasestorage.googleapis.com/v0/b/larryeparks-b3ba7.appspot.com/o/Larry%20Parks.pdf?alt=media&token=fdf17354-a846-4355-9cf1-dff7850a0e97"
        target="_blank"
        variant="secondary"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            projects into something bigger, blending tech and entrepreneurship.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/lpendeavors"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/larry-e-parks-a2aba047"
